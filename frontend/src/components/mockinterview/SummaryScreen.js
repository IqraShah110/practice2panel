      ...
      {summaryData.areas_of_improvement && (
        <div className="summary-section">
          ...
          {summaryData.areas_of_improvement.Communication && (
            <div className="improvement-card improvement-card-communication">
              <h4>Communication</h4>
          ...
          {summaryData.areas_of_improvement['Knowledge Accuracy'] && (
            <div className="improvement-card improvement-card-knowledge">
          ...
          {summaryData.areas_of_improvement.Clarity && (
            <div className="improvement-card improvement-card-clarity">
              <h4>Clarity</h4>
